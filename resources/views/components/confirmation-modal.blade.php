<!--Start.окно подтверждения закрытия-->
<div id="confirmationModal"
    ...
    <div class="bg-white w-2/3 p-6 rounded-lg shadow-lg">
        ...
        <div class="mt-4 flex space-x-2">
            <button wire:click="closeModal(true)" class="bg-red-500 text-white px-4 py-2 rounded">Да</button>
            <button wire:click="closeModal(false)" class="bg-gray-500 text-white px-4 py-2 rounded">Нет</button>
        </div>
    </div>
</div>
<!--End-->
