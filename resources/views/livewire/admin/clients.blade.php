<div class="container mx-auto p-4">
    ...
    <div id="modalBackground"
        ...
        <div id="form"
            ...
            <!-- Поля флажков -->
            <input type="checkbox" wire:model="isConflict" {{ $isConflict ? 'checked' : '' }}>
            Конфликтный
            ...
            <input type="text" wire:model.live="first_name" placeholder="Имя" class="w-full p-2 mb-2 border rounded">
            @error('first_name')
                <span class="text-red-500">{{ $message }}</span>
            @enderror
